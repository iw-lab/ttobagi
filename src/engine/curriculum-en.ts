...
export const CURRICULUM_EN: LevelSheet[] = [
  ...
  },
  {
    ...
    items: ['My left foot hurts today.', 'Have a good day at school!', 'This small box is made of wood.', 'She needs wool for a new hat.', 'Put on your hood in the rain.', 'Where is the hook for my coat?', 'We took a bus to the zoo.', 'A boy stood by the door.', 'Can we eat lunch at noon?', 'There is a frog in my boot!'],
  },
  {
